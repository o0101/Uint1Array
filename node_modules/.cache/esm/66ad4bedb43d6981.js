"use strict";;let assert,Uint1Array;_b43‍.w("assert",[["default",["assert"],function(v){assert=v}]]);_b43‍.w("./index.js",[["default",["Uint1Array"],function(v){Uint1Array=v}]]);
  ...
  function test_bitfield() {
    ...
    _b43‍.g.console.log( source, bits+'');
    const bitfield = new Uint1Array( source.buffer ); 
    _b43‍.g.console.log( source, bitfield+'');
  }
  ...
  function test_readme_3() {
    ...
    uint8[0] = 42;
    _b43‍.g.console.log(uint8[0]); // 1
    _b43‍.g.console.log(uint8.length); // 2
    _b43‍.g.console.log(Uint1Array.BYTES_PER_ELEMENT); // 0.125

    // From an array
    var arr = new Uint1Array([21,31]);
    _b43‍.g.console.log(arr[1]); // 1

    // From another TypedArray's buffer
    var x = new Uint8Array([21, 31]);
    var y = new Uint1Array(x.buffer);
    _b43‍.g.console.log(""+y); // 
